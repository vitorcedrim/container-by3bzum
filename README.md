...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-by3bzum.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-by3bzum.containers.anotherwebservice.com/
...
```
git clone git@github.com:vitorcedrim/container-by3bzum.git
cd container-by3bzum
```
...
```
docker attach container-by3bzum
```
